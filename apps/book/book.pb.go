...
type UpdateBookRequest struct {
	...
	UpdateMode UpdateMode `protobuf:"varint,2,opt,name=update_mode,json=updateMode,proto3,enum=zginkgo.ginkgo_keyauth.book.UpdateMode" json:"update_mode,omitempty"`
	// 更新人
