...
func (x *EndpiontSet) GetEndpoints() []*Endpoint {
	if x != nil {
		return x.Endpoints
	}
	return nil
...
var file_apps_endpoint_pb_endpoint_proto_rawDesc = []byte{
	...
	0x67, 0x65, 0x22, 0xec, 0x01, 0x0a, 0x08, 0x45, 0x6e, 0x64, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x12,
...
var file_apps_endpoint_pb_endpoint_proto_goTypes = []interface{}{
	...
	(*Endpoint)(nil),         // 2: ginkgo_keyauth.endpoint.Endpoint
	nil,                      // 3: ginkgo_keyauth.endpoint.Endpoint.LabelsEntry
}
var file_apps_endpoint_pb_endpoint_proto_depIdxs = []int32{
	2, // 0: ginkgo_keyauth.endpoint.EndpiontSet.endpoints:type_name -> ginkgo_keyauth.endpoint.Endpoint
	3, // 1: ginkgo_keyauth.endpoint.Endpoint.labels:type_name -> ginkgo_keyauth.endpoint.Endpoint.LabelsEntry
